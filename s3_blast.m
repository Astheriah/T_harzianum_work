...
%% RESULTADO: blast_THM10.mat   (Blast respecto a protein_clean_1.faa, TODOS los genes del .faa en cleanFiles = fileNames(contains(fileNames, 'protein_clean_1'))';)
%% RESULTADO: blast_reduced_THM10.mat   (Blast respecto a protein_clan_reduced.faa, solo los genes PRESENTES en el .mat en cleanFiles = fileNames(contains(fileNames, 'protein_clean_reduced'))';)
